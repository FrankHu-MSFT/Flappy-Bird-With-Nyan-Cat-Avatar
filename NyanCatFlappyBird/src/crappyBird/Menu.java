...
public class Menu extends JPanel{
	...
	{
		try {
			img = ImageIO.read((new java.net.URL(getClass()
					.getResource("nyan-cat-meme-hd-wallpaper-1920x1080-2441.jpg"), "nyan-cat-meme-hd-wallpaper-1920x1080-2441.jpg")));
		} catch (IOException e) {
	...
	public void paint (Graphics g){
		super.paint(g);
		BufferedImage image = img.getSubimage(100, 100, 600, 800);
		g.drawImage(image, 0, 0, null);				//paints background
